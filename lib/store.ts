...
import type { CloudProviderFilter, NavItem } from '@/lib/types/index'
...
interface ChatState {
  messages: import('@/lib/types/index').ChatMessage[]
  isStreaming: boolean
  addMessage: (message: import('@/lib/types/index').ChatMessage) => void
